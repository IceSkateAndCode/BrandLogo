...
/*
  EditCharacter screen responsibilities:
...
export default function EditCharacterScreen() {
  ...
  /*
  EditCharacter responsibilities:
...
*/
  ...
  function validate(): boolean {
    ...
    const validElements = ["Fire", "Water", "Light", "Shadow", "Electricity", "Sound", "Metal", "Life"];
    if (!validElements.includes(element.trim())) {
      Alert.alert("Element must be one of the 8 listed with the first letter capitalized.");
      return false;
    }
    return true;
  }
  ...
  if (initialLoading || authLoading) {
    return (
      <View style={[defaultStyles.container, styles.center]}>
        ...
        <Text style={defaultStyles.textStyle}>Loading character…</Text>
      </View>
    );
  }
